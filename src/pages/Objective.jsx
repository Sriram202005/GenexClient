  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-305 mx-auto">
        ...
        <blockquote className="border-l-4 border-[#800000] pl-4 text-base italic text-gray-700 bg-[#f4e1c1] p-4 mt-10 rounded-md shadow-sm">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 my-12">
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
          ...
          <div className="text-gray-700 mt-1 text-sm">Clients</div>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
          ...
          <div className="text-gray-700 mt-1 text-sm">Projects</div>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
          ...
          <div className="text-gray-700 mt-1 text-sm">Awards</div>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
          ...
          <div className="text-gray-700 mt-1 text-sm">Countries</div>
        </div>
      </div>

      <div className="max-w-4xl mx-auto my-16">
        <h2 className="text-xl font-bold text-center text-[#800000] mb-8">
          Our Journey
        </h2>
        <ol className="relative border-l-4 border-[#f4e1c1]">
          <li className="mb-10 ml-6">
            ...
            <h3 className="text-base font-semibold text-[#800000]">
      ...
      <div className="max-w-305 mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 my-16">
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col justify-center">
          <h3 className="text-lg font-bold text-[#800000] mb-4">Our Belief</h3>
          <p className="text-gray-700 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col justify-center">
          <h3 className="text-lg font-bold text-[#800000] mb-4">Our Objectives</h3>
          <p className="text-gray-700 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col justify-center">
          <h3 className="text-lg font-bold text-[#800000] mb-4">Specializations</h3>
